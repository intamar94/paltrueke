...
const content = {
  ...
  "/terminos": {
    ...
    icon: FileText,
    intro: "Pa'l Trueke es una red para conectar personas que necesitan ayuda con personas dispuestas a ayudar. El servicio funciona gracias a la responsabilidad y el buen criterio de la comunidad.",
    sections: [
      ["1. Qué es Pa'l Trueke", "La plataforma facilita la publicación y consulta de necesidades, ofertas e información comunitaria en Colombia. Pa'l Trueke no es una empresa de transporte, comercio, asistencia médica, seguridad privada ni servicio de emergencias."],
      ...
      ["9. Contacto", "Para dudas, reportes generales o cuestiones relacionadas con estas condiciones: info@paltrueke.co."],
    ],
  ...
  "/contacto": {
    ...
    note: "Pa'l Trueke está orientada a Colombia. El correo oficial de contacto es info@paltrueke.co.",
  },
};
